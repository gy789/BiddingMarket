        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <a href="/biddingmarket/seanews?biddingmarket_news_id=${news.biddingmarket_news_id}" class="btn-link">
                        <h2>
                            ${news.biddingmarket_news_title}
                        </h2>
                    </a>
...
<!-- Flot -->
<script src="<%=basePath%>/biddingmarket/js/plugins/flot/jquery.flot.js"></script>
<script src="<%=basePath%>/biddingmarket/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="<%=basePath%>/biddingmarket/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="<%=basePath%>/biddingmarket/js/plugins/flot/jquery.flot.pie.js"></script>
<!-- 自定义js -->
<script src="<%=basePath%>/biddingmarket/js/content.js"></script>
<!--flotdemo-->
